...
subtitle: {
  ...
  function make_edugirls_chart(ngo_data = [],mosque_data = [], camp_name) {
        ...
        series: {
          events: {
            click: function(e) {
              ...
              edugirls_ngo_data = edugirls_ngo_data.map(x => (x * 100));
              edugirls_mosque_data = camp_data[0];
              edugirls_mosque_data = edugirls_mosque_data.map(x => (x * 100));
